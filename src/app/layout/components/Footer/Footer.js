...
function AppFooter() {
  return (
    <div className='w-full bg-green-dark text-gray-300 text-sm pt-40 relative'>
      <img
        src='/assets/images/bg/white-bg.png'
        alt=''
        className='w-full absolute -top-72'
      />
      <InnerFooter>
          ...
          <div className='grid md:grid-cols-4 grid-cols-1 md:gap-8 gap-y-8'>
            ...
            <div className='block'>
              ...
              <div className='my-2 flex'>
                ...
                />
                <button className='inline-flex items-center px-4 border border-l-0 border-green-light bg-green text-white text-sm'>
              ...
              <aside className=''>
                <dl className='space-y-1'>
                  ...
                  <div className='flex items-start space-x-2'>
                    ...
                    <dd>
                      <span>+234 906 546 0479 +234 812 755 6291</span>
                    </dd>
                  </div>
