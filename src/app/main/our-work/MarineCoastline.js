...
import MarineSlider from './banners/MarineSlider';
import { MarineBg } from './styles';

function MarineAndCoastline() {
  return (
    <div>
      <MarineSlider />

      <MarineBg className='w-full bg-gray-100 pt-16'>
          ...
          <div className='grid md:grid-cols-2 grid-cols-1 md:gap-8 items-start md:mb-0 mb-8'>
            <div className='block'>
              ...
              <p className='text-base'>
                These comprises our activities in other habitats apart from the
                forest. We are working to raise awareness on the importance of
                these ecosystems. Equally, we are building strong advocacy in
                order to see effective government policies toward the protection
                of the marine, coastal ecosystems.
              </p>
            </div>
            <div className=''>
      ...
      <div className='w-full bg-gray-50 pt-8 pb-8'>
        <div className='max-w-7xl mx-auto md:px-0 px-8'>
          ...
          <div className='grid md:grid-cols-12 grid-cols-1 md:gap-8 gap-y-8 items-center'>
            ...
            <div className='md:col-span-7 col-span-12'>
              <p>
                Nigeria has about 853km of coastline which offers flood
                protection for coastal communities. The coastline equally serve
                migratory water birds (as resting points during migratory
                flights) and seas turtles (hatching sites). Consequently, the
                coastal communities have become important part of our campaign
                and advocacy. Some of our activities are:
              </p>
              ...
              <ul className='w-full rounded-lg mt-2 mb-3 -ml-3 text-gray-800'>
                ...
                <li className='flex items-start p-1 pl-3'>
                  ...
                  />
                  <span>
                    Awareness and community engagement aimed at changing hostile
                    behaviour towards turtles that come onshore to lay eggs,
                  </span>
                </li>
                <li className='flex items-start p-1 pl-3'>
                  <img
                  ...
                  />
                  <span>
                    Release of captured turtles back to the sea, Conservation
                    actions where nature based solutions are considered as
      ...
      <div className='max-w-7xl mx-auto py-16 md:px-0 px-8 relative z-10'>
        <div className='text-left mb-4'>
          <h2 className='font-bold text-2xl text-green'>WETLAND</h2>
        ...
        <div className='grid md:grid-cols-12 grid-cols-1 md:gap-8 gap-y-8 items-start'>
          <div className='md:col-span-7 col-span-12 pt-6'>
            <p>
              Despite their crucial ecosystem services, the wetlands are
              seriously under stress and direct encroachment as a result of
              human activities. We work to preserve the 11 internationally
              recognised wetlands in Nigeria and by extension, the
              biodiversities that depend on the ecosystem to thrive. Activities
              we engage in across wetlands where we operate are:
            </p>
            ...
            <p>
              Specifically, in Hadejia Nguru Wetlands, North-East Nigeria, we
              work with the community to restore and maintain about 70km of
              wetlands which supports livelihood for over 1,000 household in 7
              communities. The yearly commemoration of World Wetlands Day across
              the country is central to our effort at raising awareness and
              policy advocacy on the wetlands.
            </p>
          </div>
          <div className='md:col-span-5 col-span-12'>
...
export default MarineAndCoastline;
