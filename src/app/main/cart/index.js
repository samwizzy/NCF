...
const people = [
  {
    ...
    description:
      'Olympus 8×42 pro Binocular with Extra-low dispersion (ED) glass.',
    quantity: '2',
    price: '₦ 131,250',
    subtotal: '₦ 131,250',
...
function Cart() {
  return (
    <div>
                ...
                <table className='min-w-full divide-y divide-gray-200'>
                  <thead className='bg-gray-50'>
                    <tr>
                      <th
                        scope='col'
                        className='px-6 py-3 text-left text-sm font-medium text-gray-800 tracking-wider'
                      >
                        Item
                      </th>
                      <th
                        ...
                        <td className='px-6 py-4 whitespace-nowrap'>
                          <div className='flex items-center'>
                            ...
                            <div className='ml-4'>
                              ...
                              <div className='text-sm text-gray-500 w-64 whitespace-normal break-words'>
                                {person.description}
                              </div>
                            </div>
                          </div>
      ...
      <div className='max-w-7xl mx-auto md:px-8 px-4 py-8 bg-white relative z-10'>
