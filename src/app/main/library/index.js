    ...
    <div>
      ...
      <div className='w-full md:px-4 px-4 py-2 shadow-sm'>
        <div className='grid md:grid-cols-12 gap-x-2 items-center'>
          ...
          <div className='flex justify-between items-center col-span-10'>
            <h4 className='text-sm font-bold uppercase'>RECOMMENDED FOR YOU</h4>
      ...
      <div className='w-full md:px-0'>
        <div className='grid md:grid-cols-12 md:gap-x-0 gap-y-2'>
          <aside className='md:col-span-2 col-span-12 md:min-h-screen py-4 border-0 border-r border-solid border-gray-200'>
            <LibrarySideMenu />
          </aside>
          <div className='md:col-span-10 col-span-12 p-4 pb-12'>
            <div className='text-right mb-2'>
              <span className='text-sm'>Sort by: Default</span>
            </div>
            <div className='grid md:grid-cols-4 grid-cols-1 md:gap-x-16 gap-y-8 px-16'>
              {_.range(0, 8).map((i) => (
                <div>
                  <div className='max-w-md rounded overflow-hidden shadow-lg mb-4'>
                    ...
                    <div className='px-6 py-4'>
                      ...
                      <p className='text-gray-700 text-sm mb-2'>2021</p>
                    </div>
                  </div>
                  <div className='flex justify-center'>
                    <button className='bg-green hover:bg-green-800 text-white font-bold py-2 px-6'>
                      Download Here
                    </button>
                  </div>
                </div>
